...
def serializedATN():
    return [
        ...
        5,43,0,0,14,2,1,0,0,0,15,16,5,45,0,0,16,4,1,0,0,0,17,18,5,42,0,0,
        18,6,1,0,0,0,19,20,5,47,0,0,20,8,1,0,0,0,21,23,7,0,0,0,22,21,1,0,
...
class Expr3Lexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "ADD", "REST", "MULT", "DIV", "NUM", "WS" ]

    ruleNames = [ "ADD", "REST", "MULT", "DIV", "NUM", "WS" ]
